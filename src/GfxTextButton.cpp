...
void GfxTextButton::create(Adafruit_GFX* _tft,unsigned int _x, unsigned int _y, unsigned int _w, unsigned int _h, byte _fntsize, const __FlashStringHelper *_ifsh, unsigned int _fgColour, unsigned int _bgColour) {
