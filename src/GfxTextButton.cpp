...
void GfxTextButton::create(Adafruit_TFTLCD* _tft,unsigned int _x, unsigned int _y, unsigned int _w, unsigned int _h, byte _fntsize, const char* _text, unsigned int _fgColour, unsigned int _bgColour) {
